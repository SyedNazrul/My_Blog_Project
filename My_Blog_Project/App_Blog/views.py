...
from django.contrib.auth.decorators import login_required   #for use only function 
from django.contrib.auth.mixins import LoginRequiredMixin   #for use only Class 
